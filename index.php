...
<title>BUGGY BOOKING CALENDAR</title>
...
<center><h1>BUGGY BOOKING SYSTEM</h1></center>
<center><table border="1" cellpadding="5" width="800"></center>
	<tr>
		<td valign="top">
		<form action="book.php" method="post">
			<center><h3>Membership</h3></center>
			Membership:    <input checked="checked" name="membership" type="radio" value="Membership: Yes" />Yes 
			| <input name="membership" type="radio" value="Membership: No" />No 
			<p><table style="width: 70%">
				...
				<tr>
					<td>Phone Number:</td>
					<td>
					<input maxlength="20" name="phone_number" required="" type="text" /></td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				</tr>
				...
				<tr>
					<td>IC Number:</td>
					<td>
					<input maxlength="20" name="ic_number" required="" type="text" /></td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				</tr>

				<tr>
					<td>Club Golf Name:</td>
					<td>
					<input maxlength="20" name="club_golf_name" required="" type="text" /></td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				</tr>
				...
				<tr>
					<td>Buggy Needed:</td>			
					<td><input list="buggy" name="buggy" placeholder="" maxlength="50" size="20"></td>
					<datalist id= "buggy">
					<option value= "1">
			        <option value= "2">
                    <option value= "3">
			...
			<p><input name="book" type="submit" value="Book" />
		</form>
		</td>
		<td valign="top">
		...
		$calendar.= '<td class="calendar-day">';
    		...
    		if (mysqli_num_rows($result) > 0) {
    			...
    			while($row = mysqli_fetch_assoc($result)) {
    				...
    				$calendar .= "<b>" . $row["membership"] . "</b><br>ID: " . $row["id"] . "<br>" . $row["name"] . "<br>" . $row["phone_number"] . "<br>";
